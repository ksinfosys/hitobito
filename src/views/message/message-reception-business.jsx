...
function MessageReceptionBusiness() {
    ...
    const [setMessageDetailModal, setMessageDetail] = useState(false);
            ...
            <div className="p-5">
                <div className="flex border-b-2 ">
                    <button type="button" className="p-2 tab-btn tab-active">
                        <Link to="/message-reception-business">수신 메시지함</Link>
                    </button>
    ...
    <Modal
        ...
        <ModalBody className="p-5">
            ...
            <div id="detail-modal-btn" className="flex gap-2 space-between pt-5">
                <button type="button" onClick={() => {setMessageSave(true);}} className="btn btn-sm btn-outline-pending w-24">보관</button>
                <button type="button" onClick={() => {setMessageReply(true);}} className="btn btn-sm btn-pending w-24">답장</button>
            </div>
        </ModalBody>
    </Modal>
    ...
    <Modal
        ...
        <ModalBody className="p-5">
            ...
            <div id="detail-modal-btn" className="flex gap-2 space-between pt-5">
                ...
                <button type="button" className="btn btn-sm btn-pending w-24">보내기</button>
            </div>
