        ...
        <>
            <div className="find-wrap flex flex-col items-center">
                ...
                <div className="find-subtit">
                    가입시 등록한 아이디및 이메일 주소를 입력해 주세요.
                </div>
                <div className="find-email flex flex-col gap-4">
                    <input id="regular-form-1" type="text" className="h-48 form-control" placeholder="아이디를 입력해 주세요." />
                    <input id="regular-form-1" type="text" className="h-48 form-control" placeholder="이메일 주소를 입력해 주세요." />
                </div>
