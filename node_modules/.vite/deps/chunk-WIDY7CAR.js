...
function $704cf1d3b684cc5c$export$619500959fc48b26(defaultId) {
  ...
  return (0, import_react9.useMemo)(() => defaultId || `react-aria${ctx.prefix}-${++ctx.current}`, [
    defaultId
  ]);
}
...
var DropdownItem2 = React8.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = React14.forwardRef(({
    className,
    bsPrefix,
...
//# sourceMappingURL=chunk-WIDY7CAR.js.map
